...
#define POS_X_HOME_OFFSET_ADDR		ABS_Y_ENC_OFFSET_ADDR+ABS_Y_ENC_OFFSET_SIZE
#define POS_X_HOME_OFFSET_SIZE		4
#define POS_Y_HOME_OFFSET_ADDR		POS_X_HOME_OFFSET_ADDR+POS_X_HOME_OFFSET_SIZE
#define POS_Y_HOME_OFFSET_SIZE		4
