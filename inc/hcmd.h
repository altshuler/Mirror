...
#define SET_STATE			0x3000	//Set Mirror State  
#define IBIT_RESULT			0x3010	//Request Mirror Initiated BIT Results
#define GET_KEEP_ALIVE		0x3020	//Mirror Keep Alive request
#define GET_STATUS			0x3030	//Get Mirror Status  
#define GET_VER				0x3040	//Get Mirror Versions
#define GET_CNT				0x3050	//Get Mirror Lifetime Counters  
#define SET_CNT				0x3060	//Set Mirror Counters   
#define SET_IBIT			0x3070	//Perform Mirror IBIT 
#define DIR_CMD_RSP			0x2000	//Driver Direct command responce
#define	STATUS_RSP			0x4000	//Mirror Status
#define CNT_RSP				0x4010	//Mirror lifetime counters   
#define VER_RSP				0x4020	//Mirror versions   
#define IBIT_RES			0x4100	//Mirror Initiated BIT Results
#define KEEP_ALIVE_RSP		0x4110	//Mirror Keep Alive Acknowledge   
#define STATE_RSP			0x4120	//Mirror state acknowledge
#define IBIT_STATUS			0x4130	//Mirror IBIT Status
...
#define SET_HOME_POS		0x4200	//Set Home Position
#define GET_HOME_POS		0x4210	//Get Home Position
#define GET_HOME_RSP		0x4220	//Get Home Position Response
#define GO_TO_HOME_POS		0x4230	//Go To Home Position
